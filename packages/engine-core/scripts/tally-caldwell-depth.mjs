#!/usr/bin/env node
/**
 * tally-caldwell-depth.mjs — R4 ledger SELECT: zoning-facts vs depth-warm vs roads (48055).
 *
 *   DATABASE_URL=... pnpm --filter @hauska-engine/engine-core run tally-caldwell-depth
 */
...
const placeTypeDistrictCodes = resolvablePlaceTypeDistrictCodes(caldwellDescriptor);
...
try {
  ...
  const report = {
    event: "RECIPE-PROOF-48055-depth-tally",
