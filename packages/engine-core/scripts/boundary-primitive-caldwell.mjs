#!/usr/bin/env node
/**
 * boundary-primitive-caldwell.mjs — S2-U2 batch persist for Bastrop cohort.
 *
 *   PROPERTY_ATOM_PATH=1 DATABASE_URL=... TXGIO_DATABASE_URL=... \
 *     pnpm --filter @hauska-engine/engine-core run boundary-primitive-caldwell -- \
 *       [--limit=500] [--offset=0] [--parcel=48055:34785] [--dry-run]
 */
