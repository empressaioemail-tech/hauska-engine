 ...
 * roster loop runs (gradeOneParcelInQueryMode, injected by the caller — see
 * onboard-preflight.mjs) rather than a parallel harness.
 *
...
/** The shape of the extracted block13-cert-grade.mjs per-parcel grader (gradeOneParcelInQueryMode). */
...
export interface GeometrySampleDeps {
  ...
  /** The extracted block13-cert-grade.mjs grader (gradeOneParcelInQueryMode). */
