...
describe("onboard-preflight — superseded cohort threshold", () => {
  ...
  // Addendum (2026-08-03, caught live against prod fips 48021): a zero
  // DENOMINATOR from the probe means the measurement query matched no
  // parcels — "could not measure", not "measured zero". Faking a 0/0 PASS
  // is a false-PASS shape that violates honest-absence discipline.
